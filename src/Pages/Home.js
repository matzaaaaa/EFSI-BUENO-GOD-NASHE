const Home = () => {
    return (
        ...
        <body data-spy="scroll" data-target="#navbar" class="static-layout">
            ...
            <section id="testimonial" class="section-padding bg-fixed bg-white overlay" style={{ backgroundImage: 'url(img/bg-white.jpg)' }}>
                <div class="container">
                        ...
                        <div class="row">
                            <div class="testi-content testi-carousel owl-carousel">
                                <div class="testi-item text-center">
                                    ...
                                    <h4 class="testi-text"><b>ROXY</b> is best theme i used so far.<br Its ideal for guys without coding knowledge like me /> </h4>
            ...
            <section id="client" class="overlay bg-fixed" style={{ backgroundImage: 'url(img/bg-white.jpg)' }}>
                <div class="container"/>
                    <div class="section-content" data-aos="fade-up">
                        <div class="row ">
                            <div class="col-md-12">
            ...
            <section id="cta" class="bg-fixed overlay" style={{ backgroundImage: 'url(img/bg-white.jpg)' }}>
                <div class="container">
                    <div class="section-content" data-aos="fade-up">
                        <div class="row">
                            <div class="col-md-12 text-center">
            ...
            <footer class="mastfoot my-3">
                <div class="inner container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12 d-flex align-items-center">
                            <p class="mx-auto text-center mb-0">2019 Roxy. Design by<a href="https://gettemplates.co" target="_blank">GetTemplates</a>.</p>
                        </div>
